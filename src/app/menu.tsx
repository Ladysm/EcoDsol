        ...
        <div className="w-screen h-screen overflow-hidden text-[15px] bg-hero-pattern bg-cover bg-no-repeat bg-top bg-yellow">
            ...
            <div className='w-screen lg:px-[0px] flex justify-between text-white'>
                ...
                <ul className='hidden md:flex items-center space-x-10 lg:px-[30px] font-bold text-[15px] lg:py-0 text-[#fff]'>
                    ...
                    <li className='cursor-pointer' onClick={handleServicesClick}>
                        Servicios
                        {isServicesOpen && (
                            <ul className='absolute mt-2 bg-white text-black'>
                                <li className='py-2 px-4 hover:bg-gray-200 cursor-pointer'>Comunidad</li>
                                <li className='py-2 px-4 hover:bg-gray-200 cursor-pointer'>Alcaldía</li>
                                <li className='py-2 px-4 hover:bg-gray-200 cursor-pointer'>Persona Natural</li>
                                <li className='py-2 px-4 hover:bg-gray-200 cursor-pointer'>Empresa</li>
                            </ul>
                        )}
                    </li>
                ...
                <div className='space-y-1 group md:hidden px-5'>
                    ...
                    {isOpen && (
                        <ul className='bg-[#08B0DB] opacity-75 w-screen pb-10 absolute right-0 top-0 duration-150 flex flex-col space-y-3 text-[#FFF]'>
                            ...
                            <li className='flex justify-center w-full py-4 hover:bg-[#202020]'>Quienes somos</li>
                            <li className='flex justify-center w-full py-4 hover:bg-[#202020]' onClick={handleServicesClick}>
                                Servicios
                                {isServicesOpen && (
                                    <ul className='bg-[#202020] w-full'>
                                        <li className='py-2 px-4 hover:bg-gray-600 cursor-pointer'>Comunidad</li>
                                        <li className='py-2 px-4 hover:bg-gray-600 cursor-pointer'>Alcaldía</li>
                                        <li className='py-2 px-4 hover:bg-gray-600 cursor-pointer'>Persona Natural</li>
                                        <li className='py-2 px-4 hover:bg-gray-600 cursor-pointer'>Empresa</li>
                                    </ul>
                                )}
                            </li>
                            <li className='flex justify-center w-full py-4 hover:bg-[#202020]'>Contáctanos</li>
                            <li className='flex justify-center w-full py-4 hover:bg-[#202020]'>Material pedagógico</li>
                        </ul>
                    )}
                </div>
            </div>
